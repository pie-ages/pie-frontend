      ...
      <ScrollView
        ...
        <View style={styles.sectionsWrapper}>
          <View style={styles.descriptionSection}>
            <ThemedText type="smallBold" style={styles.sectionLabel} allowFontScaling={false}>Descrição</ThemedText>
            <ThemedText
              type="small"
          ...
          <View style={styles.sizeSection}>
            <ThemedText type="smallBold" style={styles.sectionLabel} allowFontScaling={false}>Tamanho</ThemedText>
            <ProductSizeSelector
              sizes={product.sizes}
          ...
          <View style={styles.row}>
            <ThemedText type="smallBold" style={styles.sectionLabel} allowFontScaling={false}>Preço</ThemedText>
          ...
          <View style={styles.row}>
            <ThemedText type="smallBold" style={styles.sectionLabel} allowFontScaling={false}>Loja</ThemedText>
